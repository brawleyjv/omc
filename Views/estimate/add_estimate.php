...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>styles.css?v=<?php echo time(); ?>"> <!-- Updated BASE_URL -->
    <style>
        .container {
            background: #fff;
            border-radius: 10px;
...
<body>
    ...
    <div class="container">
        ...
        <button class="btn styled-btn" onclick="window.location.href='<?php echo BASE_URL; ?>Views/estimate/add_estimate.php'">Start New Estimate</button> <!-- Updated BASE_URL -->
